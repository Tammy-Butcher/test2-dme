...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cf93a48-newPasswordRequirements.png",
        "newPasswordRequirements.png",
        543
      ],
      "align": "center",
      "caption": "This section defines the strength of passwords entered for DME accounts"
    }
  ]
}
[/block]
