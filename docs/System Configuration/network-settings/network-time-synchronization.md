...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/99b4410-networkTimeSync.png",
        "networkTimeSync.png",
        570
      ],
      "align": "center",
      "caption": "Network Time Synchronization fields use the Host Name or IP Address to provide synchronized times"
    }
  ]
}
[/block]
