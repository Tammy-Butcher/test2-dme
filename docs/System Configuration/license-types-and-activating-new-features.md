---
title: License Types and Activating New Features
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
The DME is a licensed product from Vbrick. There are a few different methods to licensing your DME and activating new features. For all license types, the **System Configuration** > **Activate Feature** page provides the ability to apply, maintain, and update licenses and features on the DME.
...
If you purchase a feature in the future, you may need to get your **Currently Installed License** (from the System **Configuration** > **Activate Feature** page) and contact Vbrick Support to augment the license.
...
After you receive the license file, copy and paste the entire contents of the file into the **License Content** text box. Once activated, the system license is shown on the **System Configuration** > **General** page. You are then able to use the new feature.

![](https://files.readme.io/d128f4b-activateFeature.png "activateFeature.png")
