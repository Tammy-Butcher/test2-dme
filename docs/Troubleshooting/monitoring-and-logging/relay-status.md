...
next:
  description: ''
---
The **Monitor** > **Relay Status** page displays the status of all defined relays. Click on the column header to sort the entries up or down.
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8cdb127-relayStatus.png",
        "relayStatus.png",
        645,
        297,
        "#e1e2e5"
