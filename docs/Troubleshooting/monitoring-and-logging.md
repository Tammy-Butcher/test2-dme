...
<Image title="mpsConnections.png" alt={1400} align="center" src="https://files.readme.io/a1629d6-mpsConnections.png">
  Use the MPS Connections page for various reports on the **MultiProtocol Server (MPS)** streaming types
</Image>
...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        This is the **Stream Name**, and is associated with each sub-row (to the right).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Each row may have different statistics based on the stream type. These are included within the column. Lost packets will only be listed if they exist, otherwise blank.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        This is the time the stream has been connected. In some cases, the system will display reconnects and reconnect periods.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The last column will display exception status.
      </td>
    </tr>
  </tbody>
</Table>
...
| **HLS<FUNCTION>** Where <FUNCTION> =\{ Generation \| Sub Playlist eration] \|  \| Reflection }                                                          | These represent HLS streams either being created or pulled (for distribution).                                                                                                        |
...
<Image align="center" src="https://files.readme.io/ebbb2b9a3d430794d516d4cf3d7afe17e5aab8a331482dd0b515eb835a028a17-MPSnewfetcher.png" />
