...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Upgrade Path",
    "0-0": "v<<dmeCurrent>>",
    "0-1": "Current version. No upgrade path.",
    "1-0": "v3.23.0 - v<<dmePrevious>>",
    "1-1": "Upgrade directly to the current version.  \n  \n**Note:** DME v3.31 is an OS upgrade so it may take longer to complete.  ",
    "2-0": "v3.8.0 - v3.22",
    "2-1": "Upgrade to version 3.30, and then upgrade to v3.31  \n  \n**Note:** DME v.3.14.0 introduced additional security features that REQUIRE browser cache to be cleared before accessing the DME Web UI. Also, connecting to a new ovf installed by IP is necessary until the Hostname is changed within the DME (if a fully qualified domain name is to be used). If you see 500 or 403 errors on the Login or Home page, then please refresh your cache and check your network settings.",
    "3-0": "v3.7.1",
    "3-1": "You can only upgrade to v3.8.0. On v3.8.0 you should apply the v3.8.1 patch to the DME that will be utilized for the Rev User Location Service.",
    "4-0": "v3.5.1 / v3.6.0",
    "4-1": "You can only upgrade to v3.7.1.",
    "5-0": "v3.4.4",
    "5-1": "You can only upgrade to v3.5.1. This upgrade includes an OS upgrade and will require more time to finish. Please plan accordingly.",
    "6-0": "v3.4.3 and all prior DME versions",
    "6-1": "Upgrade to v3.4.4"
  },
  "cols": 2,
  "rows": 7,
  "align": [
