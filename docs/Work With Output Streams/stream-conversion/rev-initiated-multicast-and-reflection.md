...
In this purely fictional example, the stream name is StreamName_1 and 232323 is the stream ID. This stream will utilize a 10 second segment length. However, this stream can be changed to 4 or 6 second segment lengths by appending a set-segment-duration parameter on the URL:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/23b929c-rtmpStream2Akamai.png",
        "rtmpStream2Akamai.png",
        892
      ],
      "align": "center",
      "caption": "Correct IDR Settings for Pushing an RTMP Stream to Akamai on a 9000 Encoder"
    }
  ]
}
[/block]