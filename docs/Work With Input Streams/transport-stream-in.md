...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/15d2f1c-transportStreamIn.png",
        "transportStreamIn.png",
        718
      ],
      "align": "center",
      "caption": "Use Transport Stream In to configure streams pushed via unicast or multicast"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "Stream Name",
    "0-1": "Name used within the DME to connect input and output streams. Use the default stream name (**TSPullStream1, TSPullStream2**, etc.) or override as desired. See above, MPG2TS Streams (with MP2 content) must be prepended with **mp2:**",
    "1-0": "Multicast / Localhost",
    "1-1": "Source of multicast stream/local host. If the stream is a unicast to the DME, enter the DME's IP address. For source-specific multicast addresses, enter it as \"multicastipaddress:sourceipaddress.\".  \n  \n**Example**: `232.1.1.1:172.22.2.166`  \n  \n**Note**: Source-specific multicast is _not_ supported for IPv6.",
    "2-0": "Port",
    "2-1": "Port on which the stream is unicast or multicast. If there are multiple unicast input streams, be sure that each input stream has a unique port number.",
    "3-0": "Enable",
    "3-1": "Use to enable an input stream.",
    "4-0": "Status",
    "4-1": "Read only: Disabled | Connected | Receiving"
  },
  "cols": 2,
  "rows": 5,
  "align": [
