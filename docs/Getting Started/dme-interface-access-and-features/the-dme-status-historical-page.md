...
{
  "data": {
    "0-0": "![Chart Icon](https://vbweb20.vbrick.com/xcont/dmeimages/gettingStarted/chartIcon.png \"Chart Icon\")",
    "0-1": "Clicking the **Chart** icon toggles the display of the bottom axis for each graph as well as the legend (which are both off by default.) \n\nOnce displayed, clicking on the Data set names within the Legend will toggle its display within the graph.",
    "1-0": "![Show Dropdown](https://vbweb20.vbrick.com/xcont/dmeimages/gettingStarted/showDropdown.png \"Show Dropdown\")",
    "1-1": "The **Show** drop-down allows you to pick the number of days to display. This displays today or up to the last N days. In this way, smaller more pinpointed views can be generated.",
    "2-0": "![Display Timezone](https://vbweb20.vbrick.com/xcont/dmeimages/gettingStarted/displayTimezone.png \"Display Timezone\")",
    "2-1": "The **Display Timezone** button displays the current time zone in UTC. It will be of the format UTC+#### or UTC-####, where #### is the displacement in hours off UTC. \n\nClicking this button toggles between the DME's native time zone and UTC+0000. Only the dates on the graph will change if displayed. \n\nToggling the time zone is handy when comparing graphs from multiple DMEs in different time zones, as all can be normalized to UTC+0000 and provide direct time comparisons. This relieves the need for the addition and subtraction previously necessary.",
    "3-0": "![Download CSV](https://vbweb20.vbrick.com/xcont/dmeimages/gettingStarted/downloadCsv.png \"Download CSV\")",
    "3-1": "The **Download CSV** button is for advanced users who wish to chart or investigate information offline. This downloads a file (named DMEStats-<code>/</DATE/>/to/</DATE/>/</code>.csv) of all the measurements within a comma-separated-values format – easily imported into common spreadsheet programs. \n\nThis may take a moment for the DME to generate and download, so please be patient. Each of the columns is labeled and represents a 5 minute average measurement.",
    "h-0": "Icon",
    "h-1": "Function"
  },
  "cols": 2,
...
[block:callout]
{
  "type": "info",
  "title": "Note",
  "body": "Cpu_time is not an average, but a snapshot measurement. Definitions of the included data can be found in [Squid: The Definitive Guide](https://www.amazon.com/Squid-Definitive-Guide-Duane-Wessels/dp/0596001622) or via PDF off the Internet. The data is only kept for two weeks, so please download accordingly."
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/444c182-systemThroughputGraph.png",
        "systemThroughputGraph.png",
        904,
        327,
        "#c2cbc2"
      ],
      "caption": "The System HTTP/S Throughput Graph in Mbps"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7e747d3-localCacheActivity.png",
        "localCacheActivity.png",
        904,
        268,
        "#a8c8e2"
      ],
      "caption": "The Local Cache Activity Graph details how much local DME cache is being used"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/77ee189-cpuUsage.png",
        "cpuUsage.png",
        904,
        273,
        "#e2d0d6"
      ],
      "caption": "The CPU Usage graph represents how much (aggregated) power your CPU is using"
    }
  ]
}
[/block]
...
[block:callout]
{
  "type": "warning",
  "title": "Important!",
  "body": "Be aware that Historical status page is not automatically refreshed, nor are the changes to views retained. To update this page with the latest information, re-click the link for that page in the Configuration Menu in the left pane."
}
[/block]
