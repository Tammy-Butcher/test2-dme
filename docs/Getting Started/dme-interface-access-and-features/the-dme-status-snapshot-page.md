...
[block:callout]
{
  "type": "warning",
  "title": "Important!",
  "body": "Be aware that the VBAdmin pages (including the snapshot page) are not automatically refreshed. To update any page with the latest information, click the link for that page in the **Configuration Menu** in the left pane."
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6e44745-dmeSnapshotStatus.png",
        "dmeSnapshotStatus.png",
        904,
        460,
        "#d1d1d2"
      ],
      "caption": "The Status Snapshot page is the first page viewed upon logging in to the DME"
    }
  ]
}
[/block]
...
[block:callout]
{
  "type": "info",
  "title": "Note",
  "body": "Memory MIB values retrieved by SNMP are different. Please refer to the **System Configuration > SNMP** help page."
}
[/block]
### Software Licenses
